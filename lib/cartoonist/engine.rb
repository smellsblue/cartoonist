    ...
    config.to_prepare do
      if Setting.table_exists?
        ...
        Setting::Tab.define :advanced, :order => 2 do
          ...
          Setting.define :devise_pepper, :default => "ThisTokenMustBeRegenerated....", :onchange => lambda { Devise.setup { |config| config.pepper = Setting[:devise_pepper] } }
        end
        ...
        Devise.setup do |config|
          ...
          config.mailer_sender = "no-reply@#{Setting[:domain]}"
          ...
          config.pepper = Setting[:devise_pepper]
